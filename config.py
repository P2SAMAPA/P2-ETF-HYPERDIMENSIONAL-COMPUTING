...
OUTPUT_REPO = "P2SAMAPA/p2-etf-hyperdimensional-computing-results"
...
VECTOR_DIM = 10000           # dimensionality of hypervectors
NUM_LEVELS = 5               # quantization levels for continuous values
TOP_N = 3
